...
<html>
  ...
  <body>
    ...
    <a href="interactionsform">Add New User Role</a><br/><br/>
    <table border="1" width="70%" cellpadding="2">  
      ...
      <c:forEach var="user_role" items="${list}">   
        <tr>  
          ...
          <td><a href="editinteractions/${user_role.username}">Edit</a> <a href="deleteinteractions/${user_role.username}">Delete</a></td>  
        </tr>  
      </c:forEach>  
    </table>  
    <br/> 
